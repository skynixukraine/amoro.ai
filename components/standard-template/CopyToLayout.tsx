import { ColorPreferenceType, StandardFormValuesType } from '@/common/types';
...
import classes from './CopyToLayout.module.css';
        ...
        {previewMode === 'desktop' && (
          <>
            ...
            <Box
              ...
              width={'100%'}
            >
              <div style={{ background: "#E0E0E0", width: '100%', height: '1px', marginBottom: "30px" }}></div>
